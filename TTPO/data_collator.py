...
class SelfDistillationDataCollator:
    ...
    def __call__(self, features):
        ...
        problems = []  # raw problem strings for greedy privileged mode

        for feature in features:
            # Extract problem and solution from dataset
            # Handle different possible column names
            problem = feature["problem"]
            solution = feature.get("solution", feature.get("answer", ""))
            ...
            if not self.use_greedy_privileged:
        ...
        if self.use_greedy_privileged:
            # Teacher prompts will be built dynamically in training_step
            pass
