...
class CustomScriptArguments(ScriptArguments):
    ...
    use_greedy_privileged: bool = field(
        default=False,
        metadata={
            "help": "Use greedy decoding output as teacher's privileged information instead of ground-truth solution. "
            "The model generates a greedy answer (temperature=0) first, which is used as the 'reference solution' "
            "in the teacher prompt."
        },
    )
    greedy_max_tokens: int = field(
        default=16000,
        metadata={
            "help": "Maximum tokens for the greedy generation phase when use_greedy_privileged=True."
        },
    )
...
if __name__ == "__main__":
    ...
    if script_args.run_config:
        ...
        # Extract model name from the model identifier
    ...
    if os.environ.get("LOCAL_RANK", "0") == "0":
        wandb.init(
            ...
            config={
                ...
                "use_greedy_privileged": script_args.use_greedy_privileged,
                "greedy_max_tokens": script_args.greedy_max_tokens if script_args.use_greedy_privileged else None,
            },
        )
    ...
    trainer = OPSDTrainer(
        ...
        use_greedy_privileged=script_args.use_greedy_privileged,
        greedy_max_tokens=script_args.greedy_max_tokens,
    )
