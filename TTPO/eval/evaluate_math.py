...
def evaluate_math500(
    ...
    if dataset_name.lower() == "math500":
        ...
        print(f"Loaded aime_2024 dataset with {len(dataset)} problems")
    elif dataset_name.lower() == "aime25":
        dataset = load_dataset("MathArena/aime_2025", split="train", trust_remote_code=True)
        print(f"Loaded aime_2025 dataset with {len(dataset)} problems")
    elif dataset_name.lower() == "aime26":
        dataset = load_dataset("MathArena/aime_2026", split="train", trust_remote_code=True)
        print(f"Loaded aime_2026 dataset with {len(dataset)} problems")
    elif dataset_name.lower() == "hmmt25":
        dataset = load_dataset("MathArena/hmmt_feb_2025", split="train", trust_remote_code=True)
        print(f"Loaded hmmt_feb_2025 dataset with {len(dataset)} problems")
    elif dataset_name.lower() == "hmmt26":
        dataset = load_dataset("MathArena/hmmt_feb_2026", split="train", trust_remote_code=True)
        print(f"Loaded hmmt_feb_2026 dataset with {len(dataset)} problems")
    elif dataset_name.lower() == "brumo25":
        dataset = load_dataset("MathArena/brumo_2025", split="train", trust_remote_code=True)
        print(f"Loaded brumo_2025 dataset with {len(dataset)} problems")
    else:
        raise ValueError(
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="math500",
        choices=["math500", "amo-bench", "aime24", "aime25", "aime26", "hmmt25", "hmmt26", "minerva", "amc23", "brumo25"],
